...
const AllPrimeDistributors = () => {
  ...
  const getPurchasePackages = async () => {
    let user_package = await fetch(
      "https://krushimitr.in/api/distributors/all_distributors-purchage_package_data"
    );
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0">All Prime Distributor</h4>
    ...
    <div>
      ...
      <div className="card px-3 UserCard">
        ...
        >
          ...
          <Column field="distMobile" header="Mobile" sortable></Column>
          <Column
            field="package_name"
            header="Plan"
...
export default AllPrimeDistributors;
