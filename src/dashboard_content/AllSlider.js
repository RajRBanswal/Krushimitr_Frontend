...
function AllSlider() {
  ...
  const storeSlider = async () => {
    ...
    const result = await fetch("https://krushimitr.in/api/admin/add-slider", {
      method: "POST",
      body: formData,
  ...
  const updateProduct = async (id) => {
    ...
    const result = await fetch(
      "https://krushimitr.in/api/admin/update-slider",
      {
        method: "POST",
        body: formData,
      }
  ...
  const DeleteOne = async (id) => {
    let resultDel = await fetch(
      "https://krushimitr.in/api/admin/delete-slider",
      {
        method: "post",
  ...
  const getSliderData = async () => {
    let all_slider = await fetch("https://krushimitr.in/api/admin/all-slider");
