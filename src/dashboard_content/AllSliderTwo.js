...
const AllSliderTwo = () => {
  ...
  const storeSlider = async () => {
    ...
    const result = await fetch(
      "https://krushimitr.in/api/admin/add-slider-two",
      {
        method: "POST",
        body: formData,
      }
  ...
  const updateProduct = async (id) => {
    ...
    const result = await fetch(
      "https://krushimitr.in/api/admin/update-slider-two",
      {
        method: "POST",
        body: formData,
      }
  ...
  const DeleteOne = async (id) => {
    let resultDel = await fetch(
      "https://krushimitr.in/api/admin/delete-slider-two",
      {
        method: "post",
  ...
  const getSliderData = async () => {
    let all_slider = await fetch(
      "https://krushimitr.in/api/admin/all-slider-two"
    );
    const getSlider = await all_slider.json();
    if (getSlider.status === 201) {
      setSliderTwo(getSlider.getSlider);
    } else {
      setSliderTwo("");
    }
  };
      ...
      <div className="card p-3">
        <div className="row">
          <div className="col-lg-8">
            <h2 className="text-uppercase">All Slider Two Data</h2>
          </div>
            ...
            <tbody>
              {sliderTwo.map((item) => (
                <tr key={item._id}>
                  ...
                  <td>
                    <img
                      src={`https://krushimitr.in/upload/${item.slider_image}`}
                      width={"100px"}
