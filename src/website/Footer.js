        ...
        <>
            <div className="container-fluid bg-footer bg-primary text-white pt-3">
                <div className="container">
                    <div className="row gx-5">
                        ...
                        <div className="col-lg-1 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div className="container-fluid bg-dark text-white py-3">
                <div className="container text-center">
                    <p className="mb-0" style={{fontSize:'16px'}}>&copy; Copyright<Link className="text-secondary fw-bold" to="#"> LASINA NETWORK SERVICE PRIVATE LIMITED</Link>. All Rights Reserved 2023. Designed by <Link className="text-secondary fw-bold" target='_blank' to="https://ewebdigital.com">E Web Digital</Link></p>
                </div>
            </div>
