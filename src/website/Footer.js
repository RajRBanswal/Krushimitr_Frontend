...
function Footer() {
  return (
    <>
        ...
        <div className="container">
          <div className="row gx-5">
            ...
            <div className="col-lg-3 col-md-12 pt-0 pt-lg-3 mb-3">
              ...
              >
                <Link className="text-white mb-0" to="/">
                  <i className="bi bi-arrow-right text-white me-2"></i>Home
                </Link>
                <Link className="text-white mb-0" to="/about-us">
            ...
            <div className="col-lg-3 col-md-12 pt-0 pt-lg-3 mb-3">
              <h4 className="text-white mb-2">Important Link</h4>
              <div
                className="d-flex justify-content-start"
                style={{ flexDirection: "column" }}
              >
                ...
                <Link className="text-white mb-0" to="/shipping-policy">
                  <i className="bi bi-arrow-right text-white me-2"></i>Shipping
                  Policy
                </Link>
                <Link className="text-white mb-0" to="/refund-policy">
                  <i className="bi bi-arrow-right text-white me-2"></i>Refund
                  policy
                </Link>
                <Link className="text-white mb-0" to="/return-policy">
                  <i className="bi bi-arrow-right text-white me-2"></i>Return
                  policy
                </Link>
                {/* <Link className="text-white mb-0" to="/about-us"><i className="bi bi-arrow-right text-white me-2"></i>About Us</Link> */}
              </div>
            </div>
            <div className="col-lg-2 col-md-12 pt-0 pt-lg-3 mb-3">
              <h4 className="text-white mb-4">Links</h4>
              <div className="d-flex d-lg-block mt-4">
                <Link
                  className="btn btn-secondary btn-square rounded-circle me-2 mt-2"
                  to="#"
                >
                ...
                <Link
                  className="btn btn-secondary btn-square rounded-circle mt-2"
                  to="#"
                >
        ...
        <div className="container text-center">
          <p className="mb-0" style={{ fontSize: "16px" }}>
            ...
            <Link className="text-secondary fw-bold" to="#">
              {" "}
              SHIVANERI BUSINESS PRIVATE LIMITED
            </Link>
            . All Rights Reserved 2023. Designed by{" "}
            <Link
              className="text-secondary fw-bold"
              target="_blank"
              to="https://ewebdigital.com"
            >
              E Web Digital
            </Link>
          </p>
      ...
      <Link to="#" className="btn btn-secondary py-3 fs-4 back-to-top">
